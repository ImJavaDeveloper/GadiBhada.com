...
StringBuilder htmlHeader=new StringBuilder(" <h3>Distribute Goods </h3> <table id=\"distributionTable\" class=\"table table-striped table-bordered\" style=\"width:100%\">\r\n" + 
		"        <thead>\r\n" + 
		"            <tr>\r\n" + 
		"                <th>Challan Id</th>\r\n" + 
		"                <th>Date</th>\r\n" + 
	...
	public String loadUpdateModalData(@RequestParam Integer id) {
		...
		StringBuilder updatemodalForm=new StringBuilder(
				...
				"<form class=\"form-inline\"  action=\"#\" method=\"post\" name=\"updateModalForm\" data-toggle=\"validator\">"
						...
						+"<td><label for=\"totalQty\">TotQty</label></td>"
						+"<td><label for=\"qtyAvl\">QtyAvl</label></td>"
						+"<td><label for=\"reciever\">Reciever</label></td>"
						+"<td><label for=\"distributeTo\">Distribute To</label></td>"
						+"<td><label for=\"deliverLocation\">Delivery Location</label></td>"
						+"<td><label for=\"distributeQty\">Distribute Qty</label></td>"
						+"<td><label for=\"receivingDate\">Receiving Date</label></td>"
						+ "</tr>"
						+"</thead>"
